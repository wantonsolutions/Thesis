...
interacting with its CPU.  The example above is only a high level overview of an RDMA write, the
...
require each NUMA domain to synchronize its log with a singular log master, it also requires
...
consensus~\cite{eris, nopaxos}. In this dissertation we leverage the power of programmable switches to
